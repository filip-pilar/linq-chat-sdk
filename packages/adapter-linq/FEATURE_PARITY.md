...
**`@linqapp/sdk@0.41.1`**. It exposes current native resources but removed `webhooks.unwrap()` and
...
| Linq operation                                           | Disposition               | Adapter API                                    | Status     | Limitations / completion gap                                                                                                                                                                                         | Priority | Test coverage                                                                       |
| -------------------------------------------------------- | ------------------------- | ---------------------------------------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------- |
| `GET /v3/experiences` — list invokable experiences       | Native Linq client        | `adapter.client.experiences.list()`            | Client API | Available in `@linqapp/sdk@0.41.1`; no bespoke adapter discovery API.                                                                                                                                                | —        | Endpoint behavior owned by Linq                                                     |
| `GET /v3/experiences/{experience}`                       | Native Linq client        | `adapter.client.experiences.retrieve()`        | Client API | Available in `@linqapp/sdk@0.41.1`; invocation remains native client behavior.                                                                                                                                       | —        | Endpoint behavior owned by Linq                                                     |
...
`@linqapp/sdk@0.41.1` no longer exports an unwrap union. Batch `005` must use an adapter-owned event
