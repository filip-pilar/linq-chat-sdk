...
| `007` | Standard mapping + typed chat extension            | Non-lossy message model         | **Partial.** `007A` freezes the message-options transport; `007B` adds standalone rich links and part-specific reply/reactions. Inbound/history/card/stream fidelity remains `007C`.                                                |
