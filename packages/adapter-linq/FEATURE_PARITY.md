...
| ---------------------------- | -------------------------------------------- | ------------- | ------------------------------------------------------------------ |
| Existing-chat text/media     | Standard mapping + internal behavior         | Partial       | Deferred Batch `012` media lifecycle                               |
...
| Contact sharing/read/voice   | Standard mapping + typed Linq extension      | Partial       | Implemented surfaces complete; later standard-path cleanup remains |
...
| `013` | Standard mapping + internal + typed chat extension | Remaining parity cleanup        | **Partial.** `013A` is `Contract-verified`: standard start typing now supports direct/group chats with shared errors, and stale completion language is reconciled. Broader standard-operation cleanup and future drift remain deferred.                                  |
