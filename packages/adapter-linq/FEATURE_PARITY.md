...
| ------------------------------------------ | ---------------------------------- | ------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------- |
| Linq message-options transport             | Typed Linq chat extension          | `linqMessage(content, options)`                               | Complete   | Immutable send-time metadata uses an ordinary Chat SDK postable and survives post/reply/edit plus callback-URL preprocessing. Options are not copied onto `SentMessage`/history and provider translation remains in `007B`/`010`.                 | P0       | Contract-verified postable matrix, callbacks, identity, history, serialization   |
...
| Chat SDK cards                             | Standard Chat SDK mapping          | `thread.post(<Card />)`                                       | Partial    | Text/images work; interactive controls remain labels unless a true iMessage app bridge exists.                                                                                                                                                    | P1       | Contract-verified; Provider-observed `cards`                                     |
