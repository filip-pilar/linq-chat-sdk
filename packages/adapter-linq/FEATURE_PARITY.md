...
| `006` | Typed Linq chat extension                          | Message lifecycle               | **Planned; unblocked.** `006A` covers sent/delivered/read/failed contracts; `006B` covers edited/reconciled semantics, validation, and docs without business workflows.                                                             |
