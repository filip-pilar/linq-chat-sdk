...
| `009` | Typed Linq chat extension                          | Groups and location             | **Partial.** `009A` implements existing-group update, participant add/remove, and leave as validated queued operations. `009B` location and typed group/location lifecycle observations remain planned; `009C` is optional evidence. |
