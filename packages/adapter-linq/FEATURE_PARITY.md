...
| `POST /v3/chats/{chatId}/read` — mark read                    | Typed Linq chat extension | `adapter.conversation(threadOrId).markRead()`                | Missing    | No standard Chat SDK equivalent; service constraints and idempotence need docs/tests and live evidence.                                                                                                                                          | P1       | None                                                                       |
...
| Replies (`reply_to`)                       | Typed Linq chat extension          | `LinqMessageOptions.replyTo`                                  | Missing    | Preserve optional part index on existing canonical chats and normalize inbound reply metadata beyond `raw`.                                                                                                                                   | P1       | Raw preservation unit only                                         |
